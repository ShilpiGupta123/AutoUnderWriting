...
import com.autouw.qa.page.LoginPage;
...
public class Login {
	...
	//Accepting cookies of the application.
	@Test(priority=5)
	...
	public void UserLoginWithValidUsernameAndPassword() throws InterruptedException{
		...
		try { 
			if(driver.findElement(By.xpath("//*[@class='alert alert-danger alert-dismissable']//*[@class='btn btn-login']")).isDisplayed()) {
				...
				//Click on Terms and Privacy Check box.
				...
				//Verify Login page is navigating to Dashboard Page or not.
